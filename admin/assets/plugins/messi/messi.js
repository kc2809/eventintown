...
(function () {
    ...
    function Messi(data, options) {
        ...
        // Adjust the width .css('width', _this.options.width)
    ...
    Messi.prototype = {
        ...
        template: '<div class="messi"><div class="messi-box"><div class="messi-wrapper"><div class="messi-titlebox"><span class="messi-title"></span></div><div class="messi-content content-signin"></div><div class="messi-footbox"><div class="messi-actions messi-actions-wrapper"></div></div></div></div></div>',
        content: '<div></div>',
        visible: false,
